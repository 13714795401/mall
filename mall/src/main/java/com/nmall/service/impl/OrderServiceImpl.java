...
import com.nmall.dao.*;
import com.nmall.pojo.*;
import com.nmall.service.IOrderService;
import com.nmall.util.BigDecimalUtil;
import com.nmall.util.DateTimeUtil;
import com.nmall.util.FTPUtil;
import com.nmall.util.PropertiesUtil;
import com.nmall.vo.OrderItemVo;
import com.nmall.vo.OrderProductVo;
import com.nmall.vo.OrderVo;
import com.nmall.vo.ShippingVo;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse<String> cancel(Integer userId, Long orderNo) {
        ...
        if (order.getStatus() != Const.OrderStatusEnum.CANCELED.getCode()) {
            return ServerResponse.createByErrorMessage("用户已付款,无法取消订单");
        }
    ...
    private Order assembleOrder(Integer userId, Integer shippingId, BigDecimal paument) {
    ...
    public ServerResponse<String> manageSendGoods(Long orderNo) {
        ...
        if (order != null) {
            if (order.getStatus() == Const.OrderStatusEnum.PAID.getCode()) {
                ...
                orderMapper.updateByPrimaryKeySelective(order);
                return ServerResponse.createBySuccessMessage("发货chengg");
            }
        }
        return ServerResponse.createByErrorMessage("订单不存在");
    }
